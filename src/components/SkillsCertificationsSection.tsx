...
export const SkillsCertificationsSection: React.FC = () => {
  ...
  return (
    <section id="skills" className="py-20 relative bg-[#FCF8F4]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#4A4E69] font-display">
            Tech Stack & <span className="font-serif italic text-[#9A8C98] font-normal border-b-2 border-[#FDE2E4]">Kompetensi</span>
          </h2>
        ...
        <motion.div
          ...
          className="bg-white p-6 sm:p-8 rounded-3xl border border-[#E2ECE9] shadow-sm max-w-4xl mx-auto mb-24"
        >
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-[#E2ECE9]">
            ...
            <div>
              ...
              <p className="text-xs text-[#9A8C98] font-light">
          ...
          <div className="flex flex-wrap gap-2.5">
            {SKILL_CATEGORIES[activeCategoryIndex].skills.map((skill, sIdx) => (
              <span
                key={sIdx}
                className="px-4 py-2 rounded-2xl text-xs font-semibold bg-[#FCF8F4] text-[#4A4E69] border border-[#E2ECE9] shadow-2xs hover:scale-105 transition-transform cursor-default flex items-center gap-2"
              >
                <CheckCircle className="w-3.5 h-3.5 text-[#9A8C98]" />
        ...
        <div id="certifications" className="text-center max-w-2xl mx-auto mb-12 pt-8">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#C9E4DE] text-[#4A4E69] text-xs font-semibold uppercase tracking-widest mb-3 border border-white shadow-xs">
            <Award className="w-3.5 h-3.5 text-[#4A4E69]" />
            <span>Lisensi & Sertifikasi</span>
          </div>
          <h2 className="text-3xl sm:text-4xl font-bold text-[#4A4E69] font-display">
            Sertifikasi <span className="font-serif italic text-[#9A8C98] font-normal border-b-2 border-[#FDE2E4]">Kredensial</span>
          </h2>
          <p className="text-[#9A8C98] text-sm sm:text-base mt-2 font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {CERTIFICATES.map((cert, idx) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white p-6 rounded-3xl border border-[#E2ECE9] hover:border-[#C9E4DE] transition-all shadow-sm flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  <span className="text-2xl p-2 rounded-2xl bg-[#FCF8F4] border border-[#E2ECE9] inline-block">
                    {cert.badge}
                  </span>
                  <span className="px-3 py-1 rounded-full bg-[#E2ECE9] text-[#4A4E69] text-[10px] font-mono font-bold uppercase tracking-wider">
                    {cert.issueDate}
                  </span>
                </div>
                ...
                <p className="text-xs font-bold text-[#9A8C98] mb-3 uppercase tracking-wider">
                  {cert.issuer}
                </p>
              </div>

              <div className="pt-3 border-t border-[#E2ECE9] flex items-center justify-between text-[11px] text-[#9A8C98]">
                <span>Berlaku: {cert.expiryDate || 'Lifetime'}</span>
                <span className="font-bold text-[#4A4E69] flex items-center gap-1">
                  <Shield className="w-3 h-3 text-[#9A8C98]" />
                  <span>Verified</span>
                </span>
              </div>
            </motion.div>
