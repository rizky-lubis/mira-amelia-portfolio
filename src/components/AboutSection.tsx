...
export const AboutSection: React.FC<AboutSectionProps> = ({ onOpenCVModal }) => {
  return (
    <section id="about" className="py-20 relative bg-[#FAFAFA]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#4A4E69] font-display">
            Tentang <span className="font-serif italic text-[#8B8B95] font-normal border-b-2 border-[#EFEFF2]">Mira Amelia</span>
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mb-16">
          {PROFILE_DATA.stats.map((stat, idx) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white p-5 rounded-3xl border border-[#E9E9ED] text-center hover:border-[#D4D4DB] transition-all shadow-sm"
            >
              ...
              <div className="text-[11px] text-[#8B8B95] mt-0.5 font-light">{stat.subtitle}</div>
            </motion.div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="lg:col-span-7 bg-white p-6 sm:p-8 rounded-3xl border border-[#E9E9ED] shadow-sm"
          >
            <h3 className="text-xl font-bold text-[#4A4E69] mb-4 flex items-center gap-2">
              <BookOpen className="w-5 h-5 text-[#8B8B95]" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
              <div className="p-3.5 rounded-2xl bg-[#FAFAFA] border-l-4 border-[#D4D4DB] flex items-start gap-2.5">
                <CheckCircle className="w-4 h-4 text-[#8B8B95] shrink-0 mt-0.5" />
              ...
              <div className="p-3.5 rounded-2xl bg-[#FAFAFA] border-l-4 border-[#EFEFF2] flex items-start gap-2.5">
                <UserCheck className="w-4 h-4 text-[#8B8B95] shrink-0 mt-0.5" />
                <div className="text-xs text-[#4A4E69]">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-[#8B8B95] hover:bg-[#4A4E69] text-white font-bold text-xs uppercase tracking-wider transition-all cursor-pointer shadow-xs"
            >
          ...
          >
            {/* Education Card */}
            <div className="bg-[#E9E9ED] p-6 rounded-3xl border border-[#D4D4DB] shadow-sm relative overflow-hidden">
              ...
              <p className="text-xs font-medium text-[#8B8B95] mb-3">
                {PROFILE_DATA.degree}
              </p>

              <div className="p-3.5 rounded-2xl bg-white border border-[#D4D4DB] flex items-center justify-between shadow-xs">
                <div>
                  <span className="text-[10px] text-[#8B8B95] uppercase tracking-wider font-bold block">IPK Kumulatif</span>
                  <span className="text-lg font-extrabold text-[#4A4E69] font-display">3.89 <span className="text-xs text-[#8B8B95] font-normal">/ 4.00</span></span>
                </div>
                <div className="px-2.5 py-1 rounded-full bg-[#D4D4DB] text-[#4A4E69] text-xs font-bold">
                  Cum Laude Potential
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-3xl border border-[#E9E9ED] shadow-sm">
              <h4 className="text-xs font-bold text-[#8B8B95] uppercase tracking-widest mb-4 flex items-center gap-2">
                <Layers className="w-4 h-4 text-[#8B8B95]" />
                <span>Pilar Keahlian Utama</span>
              </h4>

              <div className="space-y-3">
                <div className="p-3 rounded-2xl bg-[#FAFAFA] border border-[#E9E9ED] flex items-center justify-between">
                  <span className="text-xs font-medium text-[#4A4E69]">Full Stack Web (Laravel, React, PHP, MySQL)</span>
                  <span className="text-[10px] font-bold text-[#4A4E69] bg-[#D4D4DB] px-2.5 py-1 rounded-full">Expert</span>
                </div>
                <div className="p-3 rounded-2xl bg-[#FAFAFA] border border-[#E9E9ED] flex items-center justify-between">
                  <span className="text-xs font-medium text-[#4A4E69]">Software QA & Technical Documentation</span>
                  <span className="text-[10px] font-bold text-[#4A4E69] bg-[#EFEFF2] px-2.5 py-1 rounded-full">Experienced</span>
                </div>
                <div className="p-3 rounded-2xl bg-[#FAFAFA] border border-[#E9E9ED] flex items-center justify-between">
                  <span className="text-xs font-medium text-[#4A4E69]">Machine Learning & AI Integration</span>
                  <span className="text-[10px] font-bold text-[#4A4E69] bg-[#EFEFF2] px-2.5 py-1 rounded-full">Advanced</span>
                </div>
                <div className="p-3 rounded-2xl bg-[#FAFAFA] border border-[#E9E9ED] flex items-center justify-between">
                  <span className="text-xs font-medium text-[#4A4E69]">Networking & Security (Cisco, MTCNA)</span>
                  <span className="text-[10px] font-bold text-[#4A4E69] bg-[#E9E9ED] px-2.5 py-1 rounded-full">Certified</span>
                </div>
              </div>
            </div>
